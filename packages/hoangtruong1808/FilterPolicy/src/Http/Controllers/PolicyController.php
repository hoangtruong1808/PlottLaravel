...
class PolicyController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->view('Policy::index', [
    ...
    public function create(Request $request, Policy $policy_model)
    {
        ...
        return view('Policy::create')->with([
    ...
    public function edit($policy_id)
    {
        ...
        return view('Policy::create', compact('policy', 'title', 'code', 'select_check_points'));
    ...
    {
        try {
            return view('Policy::detail')->with([
                'title' => "Kiểm tra file",
            ]);
    ...
    public function check_file(Request $request) {
        ...
        if ($files) {
            ...
            $status = 'success';
            $html = view('Policy::result', compact('file_data'))->render();
        }
        else {
