    ...
    <div class="offcanvas-content pr-5 mr-n5">
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('/storage/avatar/{{auth()->user()->avatar}}')"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <span class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{auth()->user()->fullname}}</span>
                <div class="navi mt-2">
                    <span class="navi-link d-flex align-items-center">
                        <span class="svg-icon svg-icon-primary svg-icon-2x pr-2">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <a href="/admin/users/info/{{auth()->user()->id}}" class="navi-item">
                <div class="navi-link">
            ...
            @if (auth()->user()->ldap == 0)
                <a href="/admin/users/edit/{{auth()->user()->id}}?#security-information" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
