<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    <div class="brand flex-column-auto" id="kt_brand">
        <a href="/">
            <img alt="Logo" src="/img/plott-logo.png" style="width: 75%" />
        </a>
            ...
            <ul class="menu-nav">
                <li class="menu-item" aria-haspopup="true">
                    <a href="/admin" class="menu-link">
                        ...
                        <span class="menu-text">Trang điều khiển </span>
                    </a>
                </li>
                <li class="menu-item @if (request()->route()->getControllerClass() == "App\Http\Controllers\UserController") menu-item-active @endif" aria-haspopup="true">
                    <a href="{{ route('user_show') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item @if (request()->route()->getControllerClass() == "App\Http\Controllers\RoleController") menu-item-active @endif" aria-haspopup="true">
                    <a href="{{route('role_show')}}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                ...
                <li class="menu-item menu-item-submenu @if (request()->route()->getControllerClass() == "App\Http\Controllers\TestPolicyController") menu-item-here menu-item-toggle menu-item-open @endif" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Bộ lọc File</span>
                    ...
                    <div class="menu-submenu" kt-hidden-height="120" style="">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('policy_show') }}" class="menu-link">
                                    <span class="menu-text"><i class="far fa-calendar-alt mr-2"> </i>Quản lý bộ lọc</span>
                                </a>
                            </li>
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ route('check_file_view') }}" class="menu-link">
                                    <span class="menu-text"><i class="far fa-calendar-check mr-2"> </i>Kiểm tra file</span>
                                </a>
                            </li>
                        </ul>
                    </div>
